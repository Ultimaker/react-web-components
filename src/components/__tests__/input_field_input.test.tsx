...
describe('The InputFieldInput component', () => {
    ...
    it('should render a url input', () => {
        ...
        expect(wrapper.find('input')).toHaveLength(1);
        expect(wrapper.find('input').prop('type')).toEqual('url');
        expect(props.onChangeHandler).not.toHaveBeenCalled();
    });
    ...
    it('should focus on the input on load', () => {
        ...
        expect(focusedElement.id).toEqual('testInputField');
    });
    ...
    it('should render a static url link', () => {
        ...
        expect(wrapper.find('a').prop('href')).toEqual('https://ultimaker.com/');
    });
    ...
    it('should render a static email link', () => {
        ...
        expect(wrapper.find('input').exists()).toEqual(false);
        expect(wrapper.find('a')).toHaveLength(1);
        expect(wrapper.find('a').prop('href')).toEqual('mailto:test@ultimaker.com');
    });

    it('should render a static date', () => {
        wrapper.setProps({ staticField: 'true', type: 'date', value: '2018-09-03T10:06:48' });
        expect(wrapper.find('input').exists()).toEqual(false);
        expect(wrapper.find('div').text()).toEqual('03-09-2018');
    });
    ...
    it('should render a static select value', () => {
        ...
        expect(wrapper.find(SelectList).exists()).toEqual(false);
        expect(wrapper.find('div').text()).toEqual('Option 3');
    });

    it('should render a static image', () => {
        wrapper.setProps({ staticField: 'true', type: 'image' });
        expect(wrapper.find(ImageUpload).exists()).toEqual(false);
