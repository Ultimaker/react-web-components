...
export interface ChildrenFieldProps extends InputFieldProps {
    ...
    touched?: boolean;
    /**
     * Children are required and must include the input field
     * both in static and non-static mode.
     */
    children: any;
}

/**
 * Input field that simply renders its children.
 * It should not be used anymore with the new field setup.
 ...
 * @deprecated
 */
export const ChildrenField: React.StatelessComponent<ChildrenFieldProps> = (
    { children, touched, ...wrapperProps },
) => (
